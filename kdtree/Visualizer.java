        ...
        while (current < n) {
            ...
            if (!left && pointE.lb.contains(point)) {
                ...
                if (pointE.lb.xmax() != point.x()) {
                    ...
                    if (pointE.vert) {
                        // xmin, ymin
                        newlb = new RectHV(pointE.lb.xmin(), pointE.lb.ymin(), pointE.lb.xmax(),
                                           point.y());
                        newrt = new RectHV(pointE.lb.xmin(), point.y(), pointE.lb.xmax(),
                                           pointE.lb.ymax());
                    }
                    else { // if horizontal division
                        newlb = new RectHV(pointE.lb.xmin(), pointE.lb.ymin(), point.x(),
                                           pointE.lb.ymax());
                        newrt = new RectHV(point.x(), pointE.lb.ymin(), pointE.lb.xmax(),
                                           pointE.lb.ymax());
                    }
            ...
            if (!leftEntered) {
                ...
                if (pointE.rt.contains(point)) {
                    ...
                    RectHV newrt;
                    if (pointE.vert) {
                        newlb = new RectHV(pointE.rt.xmin(), pointE.rt.ymin(), pointE.rt.xmax(),
                                           point.y());
                        newrt = new RectHV(pointE.rt.xmin(), point.y(), pointE.rt.xmax(),
                                           pointE.rt.ymax());
                    }
                    else {
                        newlb = new RectHV(pointE.rt.xmin(), pointE.rt.ymin(), point.x(),
                                           pointE.rt.ymax());
                        newrt = new RectHV(point.x(), pointE.rt.ymin(), pointE.rt.xmax(),
                                           pointE.rt.ymax());
                    }
